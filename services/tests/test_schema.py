"""Unit tests for the shared schema verification helper.

Tests verify_schema() behavior using mocked asyncpg pools and the
generated schema executor's verify() function.
"""
