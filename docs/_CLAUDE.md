...
- **ark** (`~/Projects/ark`) -- cross-project orchestrator. Runs domain-specific orxtra instances across the project ecosystem, manages releases, files todos, coordinates multi-project workflows. orxtra is single-project; ark is the meta-orchestrator.
...
- orxtra is single-project. Cross-project coordination is ark's domain.
