...
- Identity at birth. Runs, sources, and consumers mint their principal at creation, transactionally adjacent (mint-first, idempotent). A principal orphaned by a crashed creation is harmless and left as-is -- there is never a half-created actor.
