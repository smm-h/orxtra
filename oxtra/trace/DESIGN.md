...
Cross-run knowledge base. The durable, dependency-free record of everything the system has learned.
...
The knowledge module also ingests lessons into cognee's graph for semantic retrieval. This table is the primary store; cognee is a semantic index over it.
