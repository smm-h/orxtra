...
Use just the LLM client. Or just the task scheduler. Or just the event system. Or the full stack. 24 modules across five layers, strict dependency direction, no circular imports.
</details>
